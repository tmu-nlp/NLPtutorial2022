...
date_list.append(datetime.date(2022, 5, 9))
date_list.append(datetime.date(2022, 5, 16))
date_list.append(datetime.date(2022, 5, 23))
date_list.append(datetime.date(2022, 5, 30))
date_list.append(datetime.date(2022, 6, 6))
date_list.append(datetime.date(2022, 6, 13))
date_list.append(datetime.date(2022, 6, 20))
date_list.append(datetime.date(2022, 6, 27))
date_list.append(datetime.date(2022, 7, 4))
date_list.append(datetime.date(2022, 7, 11))
date_list.append(datetime.date(2022, 7, 25))
